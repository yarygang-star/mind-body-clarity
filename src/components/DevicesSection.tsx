import { Watch, Smartphone, Wifi, CheckCircle2 } from "lucide-react";
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {devices.map((device, index) => (
            <div
              key={index}
              className="glass-card rounded-2xl p-6 hover:shadow-elevated transition-all duration-300 group relative overflow-hidden"
            >
              {/* Status badge */}
