import { Sun, Moon, Dumbbell, Droplets, TrendingUp, CheckCircle2 } from "lucide-react";
            ...
            <div className="glass-card rounded-3xl p-6 md:p-8 shadow-elevated">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3 pl-7">
                  <ActionItem icon={<Dumbbell className="w-4 h-4" />} text="Light movement only: 30-min walk, yoga, or swimming" />
                  <ActionItem icon={<Moon className="w-4 h-4" />} text="Prioritize sleep tonight — aim for 8 hours" />
                  <ActionItem icon={<Droplets className="w-4 h-4" />} text="Stay hydrated — stress markers suggest mild dehydration" />
                </div>
              </div>
