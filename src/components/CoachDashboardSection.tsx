import { Users, AlertCircle, Zap, Moon, Heart } from "lucide-react";
            ...
            <div className="glass-card rounded-3xl p-6 md:p-8 shadow-elevated">
              ...
              <div className="space-y-4">
                {clients.map((client, index) => (
                  <div key={index} className="bg-card/50 rounded-2xl p-5 border border-border/30 hover:shadow-soft transition-shadow">
                    <div className="flex flex-col md:flex-row md:items-center gap-4">
                      ...
                      <div className="flex-1 grid grid-cols-4 gap-4">
                        <MetricPill label="HRV" value={`${client.metrics.hrv} ms`} trend={client.metrics.hrvTrend} />
                        <MetricPill label="Sleep" value={`${client.metrics.sleep} hrs`} />
                        <MetricPill label="RHR" value={`${client.metrics.restingHR} bpm`} />
                        <MetricPill label="Stress" value={client.metrics.stress} />
                      </div>
