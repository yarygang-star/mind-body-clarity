      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <AnimatedItem delay={0.1}>
            <div className="rounded-3xl p-6 md:p-8 bg-muted/50 border border-border h-full">
          ...
          <AnimatedItem delay={0.2}>
            <div className="rounded-3xl p-6 md:p-8 bg-accent/5 border-2 border-accent/20 relative overflow-hidden h-full">
